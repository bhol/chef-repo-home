...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "bhol-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/bhol-chef-training"
  #   chef.validation_client_name = "bhol-chef-training-validator"
  #   chef.validation_key_path = ".chef/bhol-chef-training-validator.pem"
  # end
end
